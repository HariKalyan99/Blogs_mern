...
const BlogStoreProvider = ({children}) => {
    ...
    useEffect(() => {
        const postSignup = async(user) => {
            try{
                await axios.post('blogs-mern-six.vercel.app/auth/signup', {
                    ...user
                })
    ...
    useEffect(() => {
        const postLogin = async(user) => {
            try{
                const {data} = await axios.post('blogs-mern-six.vercel.app/auth/login', {
                    ...user
                })
    ...
    useEffect(() => {
        ...
        const fetchPostList = async() => {
            try{
                const {data} = await axios.get('blogs-mern-six.vercel.app/blogs/read', {signal});
    ...
    useEffect(() => {
        const addNewPosts = async(blog) => {
            try{
                const {data} = await axios.post('blogs-mern-six.vercel.app/blogs/new', {
    ...
    useEffect(() => {
        const removePosts = async(id) => {
            try{
                await axios.delete(`blogs-mern-six.vercel.app/blogs/remove/${id}`);
    ...
    useEffect(() => {
        const updatePosts = async({author, title, body, tags, id}) => {
            try{
                const {data} = await axios.put(`blogs-mern-six.vercel.app/blogs/edit/${id}`,{
    ...
    useEffect(() => {
        const searchPostFromList = async(title) => {
            try{
                const {data} = await axios.get(`blogs-mern-six.vercel.app/blogs/search?title=${title}`)
    ...
    useEffect(() => {
        const fetchUserBlog = async() => {
            try{
                const {data} = await axios.get(`blogs-mern-six.vercel.app/blogs/user?fullname=${JSON.parse(sessionStorage.getItem('active')).fullname}`)
    ...
    useEffect(() => {
        const fetchUserSpecificBlog = async(name) => {
            try{
                const {data} = await axios.get(`blogs-mern-six.vercel.app/blogs/user?fullname=${name}`)
    ...
    useEffect(() => {
        const fetchAllUsers = async() => {
            try{
                const {data} = await axios.get(`blogs-mern-six.vercel.app/auth/authusers`);
