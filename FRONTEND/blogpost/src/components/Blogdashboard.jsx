...
const Blogdashboard = () => {
  ...
  const handleLogout = () => {
    ...
    if(sessionStorage.getItem('active')){
      var {fullname, token, role} = JSON.parse(sessionStorage.getItem('active'));
    }
  

  if(fullname !== "Harikalyan"){
    return (
      <div>
          ...
          <header className="border-bottom lh-1 py-3">
            <div className="row flex-nowrap justify-content-between align-items-center">
              <div className="col-4 pt-1">
                <h1 className="fw-light">Hi, <span className="fw-bold text-black-50">{fullname}</span></h1>
              </div>
              ...
              {token ? <div className="col-4 d-flex justify-content-end align-items-center">
                <Link
                  to={"/signup"}
        ...
        <main className="container">
          ...
          <div className="row mb-2">
            ...
            <div className="col-md-6">
              <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div className="col p-4 d-flex flex-column position-static">
                  <h3 className="mb-0">Post a Blog</h3>
  ...
  }else if(fullname === "Harikalyan" && role === 'admin'){
    return (
      <div>
        <div className="container-fluid">
          <header className="border-bottom lh-1 py-3">
        ...
        <main className="container">
          ...
          <div className="row mb-2">
            ...
            <div className="col-md-6">
              <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div className="col p-4 d-flex flex-column position-static">
                  <h3 className="mb-0">Go to Admin panel</h3>
                  <div className="mb-1 text-body-secondary">Nov 11</div>
                  <p className="mb-auto">
                    This is a wider card with supporting text below as a natural
                    lead-in to additional content.
      ...
      <div>
        <div className="container-fluid">
          <header className="border-bottom lh-1 py-3">
            <div className="row flex-nowrap justify-content-between align-items-center">
              <div className="col-4 pt-1">
                <h1 className="fw-light">Hello there,</h1>
              </div>
              <div className="col-4 text-center">
                <a
                  className="blog-header-logo text-body-emphasis text-decoration-none"
